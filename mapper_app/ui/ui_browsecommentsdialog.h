...
public:
    ...
    void setupUi(QDialog *BrowseCommentsDialog)
    {
        if (BrowseCommentsDialog->objectName().isEmpty())
            BrowseCommentsDialog->setObjectName(QString::fromUtf8("BrowseCommentsDialog"));
        ...
        txtUsedByS->setObjectName(QString::fromUtf8("txtUsedByS"));
        ...
        txtUsedByR->setObjectName(QString::fromUtf8("txtUsedByR"));
    ...
    {
        BrowseCommentsDialog->setWindowTitle(QCoreApplication::translate("BrowseCommentsDialog", "Browse Comments", nullptr));
        label->setText(QCoreApplication::translate("BrowseCommentsDialog", "Key:", nullptr));
#if QT_CONFIG(tooltip)
        txtKey->setToolTip(QCoreApplication::translate("BrowseCommentsDialog", "<html><head/><body><p>Key of currently displayed comment. Edit to display a specific comment.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        btnPrev->setText(QCoreApplication::translate("BrowseCommentsDialog", "<-", nullptr));
        btnNext->setText(QCoreApplication::translate("BrowseCommentsDialog", "->", nullptr));
        label_2->setText(QCoreApplication::translate("BrowseCommentsDialog", "Used by Stations:", nullptr));
#if QT_CONFIG(tooltip)
        txtUsedByS->setToolTip(QCoreApplication::translate("BrowseCommentsDialog", "<html><head/><body><p>Keys of Stations which refer to this comment.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        label_3->setText(QCoreApplication::translate("BrowseCommentsDialog", "Used by Routes:", nullptr));
#if QT_CONFIG(tooltip)
        txtUsedByR->setToolTip(QCoreApplication::translate("BrowseCommentsDialog", "<html><head/><body><p>List of routes using this comment.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
