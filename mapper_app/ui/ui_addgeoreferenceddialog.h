...
public:
    ...
    void retranslateUi(QDialog *AddGeoreferencedDialog)
    {
        ...
        label_4->setText(QApplication::translate("AddGeoreferencedDialog", "SW Latitude:", nullptr));
