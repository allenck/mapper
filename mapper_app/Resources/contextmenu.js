...
google.maps.ContextMenu = function(map, options, callback) {
    ...
    this.createMenuItem = function(itemOptions, before) {
        ...
        menuItem.onclick = function() {
            ...
            google.maps.event.trigger(self, menuItem.eventName, self.position_, itemOptions.id);
        };
        if (before) {
        ...
        google.maps.event.addListener(self, 'menu_item_selected', function(pos, item)
        {
           console.log("item clicked "+ " at " + pos.lat() +","+pos.lng() + " - "+item );
        });
    };
    ...
    this.createMenuSeparator = function(itemOptions, before) {
        ...
        menuSeparator.style.cssText = "background:#020202; height:1px;";
