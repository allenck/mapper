CREATE DEFINER=`root`@`%` FUNCTION `distance`( inLat1 DOUBLE , inLon1 DOUBLE , inLat2 DOUBLE , inLon2 DOUBLE ) RETURNS double
BEGIN
DECLARE R double;
DECLARE lat1 double;
DECLARE lat2 double;
...
SET lat1 = radians( inLat1 ) ; -- * @dToRad;
SET lat2 = radians( inLat2 ) ; -- * @dToRad;
