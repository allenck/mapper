BEGIN TRANSACTION;
CREATE TEMPORARY TABLE `t1_backup` (SegmentId, Description, OneWay, Tracks, `Type`, StartLat, StartLon, EndLat, EndLon, Length, Points, StartDate, endDate, Direction, lastUpdate, pointArray, street, location);
insert into t1_backup SELECT SegmentId, Description, OneWay, Tracks, `Type`, StartLat, StartLon, EndLat, EndLon, Length, Points, StartDate, endDate, Direction, lastUpdate, pointArray, street, location from `Segments`;
DROP TABLE `Segments`;
