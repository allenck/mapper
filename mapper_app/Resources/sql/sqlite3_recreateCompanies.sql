...
INSERT INTO `t_companies`  (`key`, mnemonic, Description, routePrefix, info, startDate, endDate, firstRoute, lastRoute, lastUpdate) 
	select `key`, mnemonic, Description, routePrefix, info, startDate, endDate, firstRoute, lastRoute, lastUpdate FROM `Companies`;
PRAGMA foreign_keys = 0;
DROP TABLE `Companies`;
CREATE TABLE if not exists `Companies` (
          `key` integer NOT NULL primary key AUTOINCREMENT,
          `mnemonic` varchar(10)  default '',
...
INSERT INTO `Companies` (`key`, mnemonic,  Description, routePrefix, info, startDate, endDate,
          firstRoute, lastRoute, lastUpdate) select `key`, mnemonic, Description, routePrefix, info, startDate, endDate,
