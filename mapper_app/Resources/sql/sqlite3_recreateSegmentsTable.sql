...
CREATE TEMPORARY TABLE `t1_backup` (SegmentId, Description, OneWay, FormatOK, Tracks, `Type`, StartLat, StartLon, EndLat, EndLon,
                       Length, Points, StartDate, DoubleDate, endDate, Direction, lastUpdate, pointArray, street, NewerName, location);
insert into t1_backup SELECT SegmentId, Description, OneWay, FormatOK, Tracks, `Type`, StartLat, StartLon, EndLat, EndLon,
                       Length, Points, StartDate, DoubleDate, endDate, Direction, lastUpdate, pointArray, street, NewerName, location from `Segments`;
DROP TABLE `Segments`;
...
INSERT INTO `Segments` (SegmentId, Description, OneWay, FormatOK, Tracks,Street, NewerName, Location, `Type`, StartLat, StartLon,EndLat, EndLon,
                        Length, Points, StartDate, DoubleDate, endDate, Direction, lastUpdate, pointArray)
                        select SegmentId, Description, OneWay, FormatOK, Tracks, Street, NewerName, Location, `Type`, StartLat, StartLon,EndLat, EndLon,
