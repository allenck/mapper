...
void WebSocketTransport::textMessageReceived(const QString &messageData)
{
 ...
 if (error.error)
 {
     qWarning() << "WebSocketTransport: Failed to parse text message as JSON object:" << messageData
...
void WebSocketTransport::onReadChannelFinished()
{
 qDebug() << "QWebSocket has closed!";
