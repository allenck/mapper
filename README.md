...
5. Map displays now will pop up the Latitude and longitude. Clicking on the popup will post the data 
   to the clipboard. 
6. Mapper now sts up by default, city connections for the four cities(St Louis, Louisville, Cincinnati
   and Berlin).
...
9. The program now includes a number of predefined overlays.
