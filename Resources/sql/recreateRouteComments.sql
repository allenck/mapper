BEGIN;
CREATE TEMPORARY TABLE if not exists `t_routeComments` (`route`, `date`, `commentKey`, `CompanyKey`, `routeId`, lastUpdate);
INSERT INTO `t_routeComments`  (`route`, `date`, `commentKey`, `CompanyKey`, `routeId`, lastUpdate)
    select `route`, `date`, `commentKey`, `CompanyKey`, `routeId`, lastUpdate FROM `RouteComments`;
...
INSERT INTO `RouteComments` (`route`, `date`, `commentKey`, `CompanyKey`, `routeId`, lastUpdate)
       select `route`, `date`, `commentKey`, `CompanyKey`, `routeId`, lastUpdate FROM `t_routeComments`;
